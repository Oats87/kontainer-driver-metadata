...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.18.8-rancher1-2": {
			...
			CanalFlannel:              m("quay.io/coreos/flannel:v0.13.0-rancher1-rc1"),
		...
		"v1.19.0-rancher1-1": {
			Etcd:                      m("quay.io/coreos/etcd:v3.4.13-rancher1"),
			Kubernetes:                m("rancher/hyperkube:v1.19.0-rancher1"),
			Alpine:                    m("rancher/rke-tools:v0.1.64"),
			NginxProxy:                m("rancher/rke-tools:v0.1.64"),
			CertDownloader:            m("rancher/rke-tools:v0.1.64"),
			KubernetesServicesSidecar: m("rancher/rke-tools:v0.1.64"),
			...
			KubeDNSAutoscaler:         m("gcr.io/google_containers/cluster-proportional-autoscaler:1.8.1"),
			Flannel:                   m("quay.io/coreos/flannel:v0.13.0-rancher1-rc1"),
			FlannelCNI:                m("rancher/flannel-cni:v0.3.0-rancher6"),
			CalicoNode:                m("quay.io/calico/node:v3.16.0"),
			CalicoCNI:                 m("quay.io/calico/cni:v3.16.0"),
			CalicoControllers:         m("quay.io/calico/kube-controllers:v3.16.0"),
			CalicoCtl:                 m("quay.io/calico/ctl:v3.16.0"),
			CalicoFlexVol:             m("quay.io/calico/pod2daemon-flexvol:v3.16.0"),
			CanalNode:                 m("quay.io/calico/node:v3.16.0"),
			CanalCNI:                  m("quay.io/calico/cni:v3.16.0"),
			CanalControllers:          m("quay.io/calico/kube-controllers:v3.16.0"),
			CanalFlannel:              m("quay.io/coreos/flannel:v0.13.0-rancher1-rc1"),
			CanalFlexVol:              m("quay.io/calico/pod2daemon-flexvol:v3.16.0"),
			WeaveNode:                 m("weaveworks/weave-kube:2.6.5"),
			WeaveCNI:                  m("weaveworks/weave-npc:2.6.5"),
			PodInfraContainer:         m("gcr.io/google_containers/pause:3.2"),
			Ingress:                   m("rancher/nginx-ingress-controller:nginx-0.32.0-rancher1"),
			IngressBackend:            m("k8s.gcr.io/defaultbackend:1.5-rancher1"),
			MetricsServer:             m("gcr.io/google_containers/metrics-server:v0.3.6"),
			CoreDNS:                   m("coredns/coredns:1.7.0"),
			CoreDNSAutoscaler:         m("gcr.io/google_containers/cluster-proportional-autoscaler:1.8.1"),
			WindowsPodInfraContainer:  m("rancher/kubelet-pause:v0.1.4"),
		...
		"v1.19.1-rancher1-1": {
			Etcd:                      m("quay.io/coreos/etcd:v3.4.13-rancher1"),
			Kubernetes:                m("rancher/hyperkube:v1.19.1-rancher1"),
			Alpine:                    m("rancher/rke-tools:v0.1.64"),
			NginxProxy:                m("rancher/rke-tools:v0.1.64"),
			CertDownloader:            m("rancher/rke-tools:v0.1.64"),
			KubernetesServicesSidecar: m("rancher/rke-tools:v0.1.64"),
